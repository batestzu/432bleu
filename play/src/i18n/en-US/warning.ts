...
const warning: BaseTranslation = {
    ...
    browserNotSupported: {
        ...
        message: "Your browser ({browserName}) is no longer supported by Bleu.",
        description: "Your browser is too old to run Bleu. Please update to the latest version to continue.",
        whatToDo: "What can you do?",
        option1: "Update {browserName} to the latest version",
        option2: "Leave Bleu and use a different browser",
    ...
    pwaInstall: {
        ...
        descriptionIos: "Add Bleu to your Home Screen for a better experience and quick access.",
        feature1Title: "Quick access",
        feature1Description: "Launch Bleu from your Start menu, Dock, or desktop.",
        feature2Title: "Dedicated app window",
        feature2Description:
            "Keep Bleu separate from your browser tabs and find Bleu at a glance in your taskbar.",
        feature3Title: "Start with your computer",
        feature3Description: "Launch Bleu when your device starts.",
